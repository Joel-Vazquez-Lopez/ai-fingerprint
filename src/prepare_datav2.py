# This is the file where we will extract the data from the second csv file 
...
RAW_PATH = "data/raw/ai_fingerprinting_dataset_v2.csv"
...
# to hold the five labels together 
...
full_df.to_csv(f"{OUT_DIR}/full_dataset_v2.csv", index=False)
train_df.to_csv(f"{OUT_DIR}/train_v2.csv", index=False)
test_df.to_csv(f"{OUT_DIR}/test_v2.csv", index=False)
